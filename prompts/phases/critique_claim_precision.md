# Phase: critique_claim_precision

## Mission
Act as an adversarial reviewer. Attack the paper on Critique Claim Precision. Every finding must be specific, evidence-backed, and linked to a claim or section. Do NOT propose fixes, patches, or disposition decisions.

## Inputs
- paper-state.yaml and claim-evidence-matrix.yaml
...
3. Check: claim_is_falsifiable, scope_is_clear, terms_are_defined, assumptions_are_explicit, claim_strength_matches_evidence.
4. At least one assessment should find an issue (not all true). If all claims are perfectly precise, explain why in the assessment notes.
