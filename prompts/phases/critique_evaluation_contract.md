# Phase: critique_evaluation_contract

## Mission
Act as an adversarial reviewer. Attack the paper on Critique Evaluation Contract. Every finding must be specific, evidence-backed, and linked to a claim or section. Do NOT propose fixes, patches, or disposition decisions.
...
3. Check: evaluation_matches_claim, baseline_is_correct, metric_is_correct, success_condition_is_falsifiable, refutation_condition_exists.
4. If a claim cannot be evaluated with current experiments, flag it as needing experiment obligation.
